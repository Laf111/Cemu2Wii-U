...
(Not commited yet)
- **changeAccount.bat** : change the account (800000X) used (remane folders in a MLC_PATH). So you can rename your existing CEMU accounts before synchronizing or  bypass the CEMU version limitation with using only the 8000001 account (the only one supported on CEMU < 1.15.19) or .
