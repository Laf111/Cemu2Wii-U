...
The workaround consists in forcing the timestamp to 0 : files are injected with this date (0) and so as they are not anteriors to the timestamp value (0) and will not be rejected.
